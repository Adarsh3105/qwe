...
def check(query):
    ...
    welcome=("welcome","my pleasure","thankyou","thanks","thank you")
    ...
    if any(s in query for s in greetings):
        res="Hey there!, I'm Dorona bot"
    elif any(s in query for s in maker):
        res="I was made by Adarsh, Naman and Pulkit."
